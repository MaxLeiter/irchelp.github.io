...
<!--
            ...
            <div class="content">
                                <p>; Simple script to allow /who wildcard searches, such as to find servers
...
;   /whosearch <em>home.com     (will match e.g. c123456-a.smateo1.sfba.home.com)
; To find servers that allow those without reverse DNS and show up with IPs:
;   /whosearch 2??.</em>.<em>.</em>     (will match IPs like 234.5.67.89)
; To find servers that allow those without identd and show up with ~:
;   /whosearch <em>~</em>
;
ALIAS WhoSearch {</p>

<p>UNSET %Who.Replies.Servers</p>

<p>%Who.Replies.Search = $$1</p>

<p>WHO $1</p>

<p>.ENABLE #WhoSearch</p>

<p>}</p>

<h1>WhoSearch off</h1>

<p>RAW 352:*:IF (($5 !ISIN %Who.Replies.Servers) &amp;&amp; ((%Who.Replies.Search ISWM $3) || (%Who.Replies.Search ISWM $4))) %Who.Replies.Servers = %Who.Replies.Servers $5</p>

<p>RAW 315:* {</p>

<p>.TIMER 1 0 ECHO -a Found these servers used by user&#8217;s hosts matching %Who.Replies.Search $+ : %Who.Replies.Servers</p>

<p>UNSET %Who.Replies.Search %Who.Replies.Servers</p>

<p>.DISABLE #WhoSearch</p>
